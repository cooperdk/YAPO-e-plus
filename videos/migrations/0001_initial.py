    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scene_tags', models.ManyToManyField(blank=True, null=True, related_name='scenes', to='videos.SceneTag')),
                ('websites', models.ManyToManyField(blank=True, null=True, related_name='scenes', to='videos.Website')),
            ],
        ),
        migrations.CreateModel(
            name='Playlist',
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('scenes', models.ManyToManyField(blank=True, null=True, related_name='playlists', to='videos.Scene')),
            ],
        ),
        migrations.CreateModel(
            name='Folder',
            fields=[
                ...
                ('scenes', models.ManyToManyField(null=True, related_name='folders_in_tree', to='videos.Scene')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exclusions', models.TextField(blank=True, default='', null=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('scene_tags', models.ManyToManyField(blank=True, null=True, related_name='actor_tags', to='videos.SceneTag')),
            ],
        ),
        migrations.AddField(
            model_name='actor',
